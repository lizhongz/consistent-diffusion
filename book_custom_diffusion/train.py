...
class CustomDiffusionDataset(Dataset):
    ...
    def __init__(
        ...
        self.image_transforms = transforms.Compose(
            [
                self.flip,
                # It doesnt change the aspect ratio.
...
def main(args):
        ...
        for i, concept in enumerate(args.concepts_list):
            ...
            if args.real_prior:
                ...
                if cur_class_images < args.num_class_images:
                    ...
                    class_prompt = concept.get('class_prompt')
                    logger.info(f'Generating with class prompt: {class_prompt}.')
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet), accelerator.accumulate(text_encoder), torch.autocast('cuda'):
